...
THRIFT_CPPFLAGS := -DHAVE_CONFIG_H -D__GLIBC__ -std=c++11
...
THRIFT_SRC_FILES := \
    ...
    $(SRC_PATH)/async/TConcurrentClientSyncInfo.cpp \
    ...
    $(SRC_PATH)/concurrency/BoostMonitor.cpp \
    $(SRC_PATH)/concurrency/BoostMutex.cpp \
    $(SRC_PATH)/concurrency/BoostThreadFactory.cpp \
